      ...
      <div className="col-span-1 md:col-span-3">
        ...
        <div className="space-y-6 md:space-y-8">
          ...
          <div>
            <a
              href="/cabins"
              className="inline-block mt-4 bg-accent-500 px-6 md:px-8 py-4 md:py-5 text-primary-800 text-base md:text-lg font-semibold hover:bg-accent-600 transition-all"
            >
